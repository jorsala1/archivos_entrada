function forIn_forOf(): void {
    const x: number[] = [0, 1, 4, 5, 6, 7, 8, 9];
    const y: number[] = new Array(15 - 5);
    ...
    /********************************************************************/
    const x2: number[] = [0, 1, 4, 5, 6];
    const auxiliares: string[][] = [["Erik", "Pavel"], ["Maeda", "Christian"]];
    // y : number[][] = [[6,9],[7,8]];
...
function ternario(n : number, m : boolean) : string{
    const flag1:number = n == 2 ? 30 : 40;
    const flag2:number = n == 1 ? 20 : flag1;
    let val1: number = n == 0 ? 10 : flag2; 
    let ternario_ = val1 == 40 && m ? "Correcto Ternario 1" : "Incorrecto Ternario1"; 
    console.log(ternario_);
    const flagCadena:string =  val1 == 40 ? "Correcto Ternario 2" : "Incorrecto Ternario 2";
    ternario_ = val1 != 40 ? "Incorrecto Ternario2" : flagCadena; 
    return ternario_;
}
