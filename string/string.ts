function StringFunction():void{
    ...
    let strtemp:string = str1 + ' SI SALE';
    console.log(strtemp.toLowerCase());
    console.log('length:');
...
function todas(parametro : string) : void{
    ...
    let toLowerCase_:string = "Hola".toLowerCase();
    let charAt_:string = toLowerCase_.charAt(0);
    console.log(charAt_);
    let concat_ :string= charAt_.concat(parametro);
    let toUpperCase_:String = concat_.toUpperCase();
    console.log(toUpperCase_);
}
